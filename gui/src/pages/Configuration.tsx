...
export default function Configuration() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="font-semibold text-gray-200">Configuration</h1>

      {/* Stored in the browser only; sent as X-Engine-Token on every request */}
      <section className="max-w-xl">
        <h3 className="text-sm font-semibold text-gray-300 mb-3 border-b border-gray-800 pb-2 flex items-center gap-2">
